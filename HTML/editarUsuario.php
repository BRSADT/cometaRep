...
?>
   ...
   <div class="panel-footer">
          ...
          <input type="submit"        <a href="editarUsuario.php" data-original-title="Edit this user" data-toggle="tooltip" type="button" class="btn btn-sm btn-warning"><i class="glyphicon glyphicon-edit"></i></a> />
